...
abstract class Model extends Eloquent {
  ...
  protected function prepareEloquentAttributes() {
    $deleted_at = (method_exists($this, 'getDeletedAtColumn')) ? $this->getDeletedAtColumn() : null;
    $created_at = $this->getCreatedAtColumn();
    $updated_at = $this->getUpdatedAtColumn();

    static::$eloquent_attributes = $deleted_at ? array ($deleted_at, $created_at, $updated_at) : array ($deleted_at, $created_at, $updated_at);
  }
  ...
  protected function getAllAttributes() {
    if (empty(static::$all_attributes)) {
      $this->prepareAllAttributes();
    }
  ...
  protected function getEloquentAttributes() {
    if (empty(static::$eloquent_attributes)) {
      $this->prepareEloquentAttributes();
    }
